...
- `QuoteTriggerDependencies`: production composition root and trigger test seam.
...
- `QuoteTrigger` / `QuoteTriggerTest`: metadata-controlled implementation selection tested by firing the trigger with mocked policy and service abstractions.
